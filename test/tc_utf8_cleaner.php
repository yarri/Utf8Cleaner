...
class TcUtf8Cleaner extends TcBase {
	...
	function test(){
		...
		$this->assertEquals("?Příliš? žl?uťoučký kůň úpěl ďábelské ódy?",\Yarri\Utf8Cleaner::Clean("{$invalid}Příliš{$invalid} žl{$invalid}uťoučký kůň úpěl ďábelské ódy{$invalid}",array("replacement" => "?")));
